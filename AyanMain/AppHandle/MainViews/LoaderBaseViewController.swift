...
class LoaderBaseViewController: ScrollViewController {
    ...
    var messageBackView: UIView = {
        let view = UIView()
            ...
            view.layer.borderColor = #colorLiteral(red: 0.1607843137, green: 0.2431372549, blue: 0.4235294118, alpha: 1)
    ...
    var messageLabel: UILabel = {
        let label = UILabel()
            label.textColor =  #colorLiteral(red: 0.1607843137, green: 0.2431372549, blue: 0.4235294118, alpha: 1)
    ...
    var loader: UIActivityIndicatorView = {
        let loader = UIActivityIndicatorView()
            ...
            loader.layer.borderColor =  #colorLiteral(red: 0.1607843137, green: 0.2431372549, blue: 0.4235294118, alpha: 1)
            ...
            loader.color = #colorLiteral(red: 0.1607843137, green: 0.2431372549, blue: 0.4235294118, alpha: 1)

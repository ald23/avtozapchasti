...
class ChooseGroupViewController: LoaderBaseViewController {
    ...
    var nextViewController = ChooseCategoryViewController()
...
extension ChooseGroupViewController : UITableViewDelegate, UITableViewDataSource {
...
extension ChooseGroupViewController {
